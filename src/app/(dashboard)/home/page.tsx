        ...
        <div className="max-w-7xl mx-auto space-y-16 sm:space-y-20 lg:space-y-24">
          ...
          <header className="text-center space-y-6 animate-fade-in-up">
            <div className="space-y-4">
              ...
              <h1 className="scroll-m-20 text-center text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight text-balance leading-tight">
                Create Perfect
                <br />
                <span className="text-primary">Thumbnails</span>
              </h1>
          ...
          {/* Main Content Area */}
          <main className="bg-card/50 backdrop-blur-sm rounded-3xl shadow-2xl border border-border/50 overflow-hidden">
            ...
            <section className="p-8 sm:p-12 lg:p-16">
              <div className="text-center mb-12 space-y-4">
                ...
                <h2 className="text-3xl sm:text-4xl font-bold text-foreground text-balance">Upload & Transform</h2>
